...
export interface MessageIconActionsProps {
  ...
  /** Turn theoretical cost, appended as `· 花费 ¥0.0038`; omitted when unpriced. */
...
export function MessageIconActions({
  text, time, runMs, ttftMs, tokensPerSecond, cost, clock, onBranch, branchUnavailable = false, className,
  extraActions, t,
